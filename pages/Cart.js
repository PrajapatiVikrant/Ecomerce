    ...
    const openrazorpay = (data)=>{
        const options = {
         ...
         handler:async function(response){
          let res = await axios.post('https://ecomerce-backend-two.vercel.app//api/order/verify',{response},{
            headers:{
          ...
          if(res.data === 'sign valid')
           console.log(res.data)
            await axios.post('https://ecomerce-backend-two.vercel.app//api/order',{data:cartList,total_price:total},{
                headers:{
                  Authorization: `Bearer ${localStorage.getItem('token')}`, 
                }
              } )
...
async function orderNow(){
    ...
    const orderRes = await axios.post(`https://ecomerce-backend-two.vercel.app//api/order/order`,{amount:total},{
        headers:{
          Authorization: `Bearer ${localStorage.getItem('token')}`, 
        }
      } )
