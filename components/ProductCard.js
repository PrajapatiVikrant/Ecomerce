...
async function addToCart(){
  const data = await axios.post('https://expert-carnival-ww9776xrgqpfg6wj-3000.app.github.dev/api/cart',{category:category,url:productImg,name:productName,price:discountPrice},{
    headers:{
